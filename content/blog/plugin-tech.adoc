...
summary: "In this article I further analyze how a Plugin Development Kit (PDK)
could be implemented in Rust. It merely collects all the information I've found
so far and present it as a summary."
