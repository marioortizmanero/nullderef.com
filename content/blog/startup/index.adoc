...
Leadership has a huge influence on the team. They shouldn't be overworking.

Shopify's "trust battery": dictates whether a relationship between two people is well. Otherwise, it results in people exploding.
