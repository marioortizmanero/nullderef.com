...
////
TODO: maybe add mail conversation with Michael?

Also add how this is more or less missing in the nomicon and why the confusion.
Explain how it's a misconception.
https://doc.rust-lang.org/nomicon/repr-rust.html?highlight=repr(rust)#reprrust
////
