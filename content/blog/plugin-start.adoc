...
in order to interact from different programming languages <<witx-guide>>. They
look like this:
...
Basically, they were all over the place in the traits I was trying to make
plugin-compatible. There are ways to work around these, but they of course mean
additional overhead:
...
Generics in plugins are fundamentally impossible, though. In Rust,
...
- [[[generics,       10]]] https://doc.rust-lang.org/book/ch10-01-syntax.html#performance-of-code-using-generics
