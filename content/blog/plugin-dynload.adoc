...
summary: "Dynamic loading is a complicated task if you start from the scratch.
You'll have to figure out how to handle versioning, plugin loading, state, and
error handling, among other things."
