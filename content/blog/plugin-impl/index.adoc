...
plain synchronous calls, it may inevitable if your program uses asynchronous
...
So that's been my road to implementing the first versions of Tremor's PDK. It
still needs some polishing, but it works! The next and last article will cover
the final cleaning up, testing and benchmarking required to make our plugin
