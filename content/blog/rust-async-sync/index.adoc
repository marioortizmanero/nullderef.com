...
tags: ["rust", "async", "macros", "procedural macros"]
date: 2024-01-14
GHissueID: 34
---
...
// TODO: double-check that it actually kills concurrency
...
way to do this is with a Tokio
...
There are a few crates that have this problem currently:
